...
class User extends Authenticatable
{
    ...
    /**
     * Get the stock opname records for this user.
     */
    ...
    /**
     * Check if user can take stock.
     */
    public function canTakeStock(): bool
    {
        return in_array($this->role, ['admin', 'stock_taker']);
    }
    ...
    {
        return in_array($this->role, ['admin', 'stock_taker', 'viewer']);
    }
}